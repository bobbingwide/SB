 ...
 * @return string
 */
function sb_render_block_core_navigation_link( $attributes, $content, $block ) {
	$attributes = sb_fiddle_nav_atts( $attributes );
	$block->context = sb_fiddle_block_context( $attributes, $block );
 ...
 * @return mixed
 */
function sb_fiddle_nav_atts( $attributes ) {
	if  ( isset( $attributes['url'] ) ) {
		$attributes['url']=str_replace( 'https://s.b/bigram', site_url(), $attributes['url'] );
 ...
 *
 * sb_fiddle_nav_atts() changes the url attribute
 ...
 * @return mixed
 */
function sb_fiddle_block_context( $attributes, $block ) {
